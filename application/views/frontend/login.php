<html lang="en">
   <head>
      ...
      <title>NFT Generator <?php echo $title ?></title>
      ...
      <div id="root">
         ...
         <div class="auth-page">
            <div class="form" style="max-width: 500px;">
               <div class="title">
                  <img src="assets/logo.png" alt="NFT Finder Logo" style="height: 165px; margin-bottom: 1rem;">
                 
               </div>
               <form id="register-form" onsubmit="return submit_form()">
                  <div class="mb-4">
                     <div class="my-3"><label for="email">Email</label><input required="" name="email" type="email" placeholder="Email" value=""></div>
                     <div class="my-3"><label for="password">Password</label><input type="password" name="password"  placeholder="Password" value=""></div>
                     <span id="from-error"></span>
                     <div class="mt-6">
                        <button class="login-button btn-primary" type="submit" class="btn-primary" type="submit" style="width: 100%;">Login</button>
                        <div class="mt-6"><a class="text-primary text-sm " href="<?php echo base_url('home/register') ?>">Don’t have an account yet? Sign up Here.</a></div>
                     </div>
                  </div>
               </form>
            </div>
