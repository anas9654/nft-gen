         ...
         <?php
              $num = 0;
                  foreach ($nftLinks as $n) {
                    ...
                    {
                     ?>
                      <div class="px-2 mb-4"><a rel="noopener noreferrer nofollow" href="<?php echo $nftLinks[$num] ?>" target="_blank">
                    <div class="transition-transform mt-2 md:hover:-translate-y-2 h-full shadow hover:shadow-lg rounded-lg overflow-hidden "
                        ...
                        <div class="relative flex flex-col min-w-0 break-words bg-transparent w-full h-full">
                            <div class="w-full h-full align-middle overflow-hidden relative svelte-f3nlpp"><img
                                    class="w-full h-full align-middle object-cover dark:brightness-80 dark:contrast-103 svelte-f3nlpp"
                                    alt="Cool Pigz"
