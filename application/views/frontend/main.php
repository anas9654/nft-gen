   ...
   <?php include('include/header.php') ?>
      <div class="p-2 flex sm:flex-row flex-col sm:overflow-hidden overflow-y-auto content">
         <div class="controls-wrapper shadow-c">
            <div class="btn-list">
               <div class="scroll"><button class="btn-secondary active">Solana NFTs</button><button class="btn-secondary false">ETH NFTs</button><button class="btn-secondary false">Upcoming Solana NFTs</button><button class="btn-secondary false">Upcoming ETH NFTs</button><button class="btn-secondary false">Crypto Alerts</button></div>
            </div>
