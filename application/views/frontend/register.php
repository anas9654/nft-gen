<html lang="en">
   <head>
      ...
      <script type="module" crossorigin="" src="/assets/index.efbcd3db.js"></script>
      <link rel="modulepreload" href="/assets/vendor.9ca71b47.js">
      <style id="_goober"> @keyframes go2264125279 {
	from {
...
</style><style id="mnetGetCss" type="text/css">div.content {
...
.form {
	...
	padding: 1rem;
	box-shadow: 0 4px 13px #c8c8c866
}
...
.form .title a {
	...
	line-height: 1.25rem;
	--tw-text-opacity: 1;
	color: rgb(37 190 75 / var(--tw-text-opacity))
}
...
.form_admin input::-moz-placeholder {
	font-size: .875rem;
	line-height: 1.25rem
}

.form_admin input:-ms-input-placeholder {
	font-size: .875rem;
	line-height: 1.25rem
}

.form_admin input::placeholder {
	font-size: .875rem;
	line-height: 1.25rem
}
...
select:hover {
	--tw-border-opacity: 1;
	border-color: rgb(37 190 75 / var(--tw-border-opacity));
	--tw-bg-opacity: .5
}
...
.btn-yt {
	box-shadow: 0 4px 13px #dc262680
}
...
.btn-fb {
	box-shadow: 0 4px 13px #2563eb80
}
...
.side-bar a {
	...
	border-color: rgb(37 190 75 / var(--tw-border-opacity));
	--tw-border-opacity: .05;
	background-color: rgb(37 190 75 / var(--tw-bg-opacity));
	--tw-bg-opacity: .15;
	padding: .5rem 1rem;
	text-align: center;
	font-size: .875rem;
...
.side-bar a.active:hover {
	--tw-bg-opacity: .95
}

.side-bar a.active:focus {
	--tw-border-opacity: .25
}

.side-bar a.active:active {
	--tw-scale-x: .95;
	--tw-scale-y: .95;
	transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skew(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
	--tw-bg-opacity: .9
...
.side-bar a.active {
	box-shadow: 0 4px 13px #3acc007f
}
...
.text-primary {
	--tw-text-opacity: 1;
	color: rgb(7 110 225 / var(--tw-text-opacity));
}
...
.btn-primary {
	...
	border-radius: .5rem;
	border-width: 1px;
	border-color: rgb(7 110 225 / var(--tw-border-opacity));
	--tw-border-opacity: .05;
	background-color: rgb(7 110 225 / var(--tw-bg-opacity));
	--tw-bg-opacity: 1;
	padding: .5rem 1.5rem;
	--tw-text-opacity: 1;
	color: rgb(255 255 255 / var(--tw-text-opacity));
...
.btn-primary {
	box-shadow: 0 1px 2px rgb(7 110 225 / var(--tw-bg-opacity))
}
...
.btn-download {
	box-shadow: 0 4px 13px #4d7cfe80
}
...
canvas {
	box-shadow: 0 4px 13px #91919166
}
...
.auth-page {
	...
	align-items: center;
	justify-content: center;
	background-image: url(/assets/background.1d1cef8d.jpg)
}
...
.auth-page .form input::-moz-placeholder {
	font-size: .875rem;
	line-height: 1.25rem
}

.auth-page .form input:-ms-input-placeholder {
	font-size: .875rem;
	line-height: 1.25rem
}
   ...
   <body style="">
      <div id="root">
         ...
         <div class="auth-page">
            <div class="form" style="max-width: 500px;">
               <div class="title">
                  <img src="assets/logo.png" alt="NFT Finder Logo" style="height: 75px; margin-bottom: 1rem;">
                  <h1>Signup</h1>
                  <p class="text-sm text-gray-400">Create your account below </p>
               </div>
               <form id="register-form" onsubmit="return submit_form()">
                  <div class="mb-4">
                     <div class="my-3"><label for="email">Email*</label><input name="email"  required type="email" placeholder="Email" value=""></div>
                     <div class="my-3"><label for="password">Password*</label><input name="password" required type="password" placeholder="Password" value=""></div>
                     <div class="my-3"><label for="repeat-password">Repeat Password*</label><input required name="confirm_password" type="password" placeholder="Password" value=""></div>
                     <span id="from-error"></span>
                     <div class="mt-6">
                         <button class="btn-primary login-button" type="submit" style="width: 100%;">Signup</button>
                     </div>
                     <div class="mt-6"><a class="text-primary text-sm " href="<?php echo base_url('home') ?>">Already have an account? Log in Here.</a></div>
                  </div>
               </form>
            </div>
         </div>
      ...
      <script>
          function submit_form(){
            $('.login-button').html('<i class="fas fa-spinner fa-pulse"></i>');
