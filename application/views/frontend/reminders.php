      ...
      <div class="p-2 flex sm:flex-row flex-col sm:overflow-hidden overflow-y-auto content">
         ...
         <section>
                        <div
                            ...
                            <?php
                  foreach ($nfts as $key=>$n) {
                    $nft=(array) json_decode($n['data']);
                    if(1)
                    {
                      
                     ?>
                            <div class="px-2 mb-4"><a rel="noopener noreferrer nofollow"
                                    href="<?php echo $nft['links'][1] ?>" target="_blank">
                                    <div class="transition-transform mt-2 md:hover:-translate-y-2 h-full shadow hover:shadow-lg rounded-lg overflow-hidden "
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <img class="w-full h-full align-middle object-cover dark:brightness-80 dark:contrast-103 svelte-f3nlpp"
                                                    alt="Cool Pigz" src="<?php echo $nft['image'] ?>"
                                            ...
                                            <div class="absolute bottom-0 left-0 right-0">
                                                <blockquote slot="bottom"
                                                    ...
                                                    <h4 class="w-full text-left text-sm sm:text-base font-extrabold text-blueGray-dark dark:text-dark-text border-gray-200"
                                                        data-ellipsis-id="1"><?php echo $nft['name'] ?>
                                                    </h4>
                                                    <div
                                                ...
                                                rel="noopener noreferrer nofollow" href="<?php echo $nft['links'][0] ?>"
                                                target="_blank">Website <span class="ml-0.5"><i
                                                        class="fas fa-globe sm"></i></span></a></div>
                                                        </div>
                                                        <?php } ?>
                                                        <a href="<?php echo $nft['links'][1] ?>">
                                                            <button
                                        ...
                                        <?php if($nft['links'][1]){?>
                                        <div class="hover:text-blueGray-lightHover"><a
                                                rel="noopener noreferrer nofollow" href="<?php echo $nft['links'][1] ?>"
                                                target="_blank">Twitter <span class="ml-0.5"><i
                                                        class="fas fa-globe sm"></i></span></a></div>
                                                        <?php } ?>
                                                        <?php if($nft['links'][2]){?>
                                        <div class="hover:text-blueGray-lightHover"><a
                                                rel="noopener noreferrer nofollow" href="<?php echo $nft['links'][2] ?>"
